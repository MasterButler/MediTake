 ...
 */
public class AddScheduleReviewFragment extends Fragment {
    ...
    public static AddScheduleReviewFragment newInstance(int sectionNumber, Schedule schedule) {
        AddScheduleReviewFragment fragment = new AddScheduleReviewFragment();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        linScheduleTime.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                if(OnViewScheduleDetailsFragmentInteractionListener != null){
